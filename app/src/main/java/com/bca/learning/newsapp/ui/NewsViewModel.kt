...
class NewsViewModel @Inject constructor(
    ...
    init {
        ...
        pagingDataFlow = searches
            .flatMapLatest { searchNews(queryString = it.query) }
    ...
    private fun searchNews(queryString: String): Flow<PagingData<UiModel>> =
        newsRepository.getSearchNewsStream(queryString)
